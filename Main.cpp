...
int main() {
    ...
    Texture FireplantTexture;
    if (!FireplantTexture.loadFromFile("Images\\fplant.png"))
    {
        return 1;
    }
    ...
    if (validity) {
        ...
        while (window.isOpen())
        {
            ...
            while (window.pollEvent(event))
            {
                ...
                else if (event.type == Event::MouseButtonPressed && event.mouseButton.button == Mouse::Left)
                {
                    ...
                    if (x == 0 && (y >= 0 && y < 3)) {
                        ...
                        if (y == 1){
                            Plant* po1 = new FirePlant(FireplantTexture, bulletTexture);
            ...
            // Texture opta;
            // if (!opta.loadFromFile("Images\\plant.png"))
            // {
            //     return 1;
            // }
            // Texture optb;
            // if (!optb.loadFromFile("Images\\fplant.png"))
            // {
            //     return 1;
            // }
            ...
            // Opta.setPosition(0.0 , 0.0);
            // Optb.setPosition(72.0 , 0.0);

            // Opta.setScale(128.0,72.0);
            // Optb.setScale(128.0,72.0);
